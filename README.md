...
- **Artist page** — bio, lineup, discography, singles, **system playlists** (Audio tab), **Video** / **Library** tabs when those folders exist under the artist (same level as `Audio` / `Gallery`), gallery, word cloud, quizzes (song quiz strips vinyl prefixes like the tracklist)
