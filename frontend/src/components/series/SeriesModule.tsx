...
import SeriesFranchisePage from "./SeriesFranchisePage";
...
export default function SeriesModule({
  ...
  const [tab, setTab] = useState<SeriesTab>(franchiseId ? "catalog" : "home");
  ...
  return (
    <div className="series-module">
      <ModuleTopBar
        ...
        tabs={[
          ...
          },
          {
            id: "catalog",
            label: "CATALOG",
            active: tab === "catalog" || Boolean(franchiseId),
            onClick: () => {
              setTab("catalog");
              onNavigate({
                franchiseId: undefined,
        ...
        menu={
          <>
            ...
            {tab === "catalog" && !franchiseId && onSetOrientation ? (
      ...
      {error && !franchiseId ? <div className="error">{error}</div> : null}
      ...
      {franchiseId ? (
        ...
        <SeriesBrowse
          ...
          onOpen={(franchiseId, subseriesId) =>
            onNavigate({
              franchiseId,
              subseriesId,
              seasonId: undefined,
