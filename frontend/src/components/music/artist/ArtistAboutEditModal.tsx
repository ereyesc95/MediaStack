...
import { fetchFilterOptions, patchBandAbout } from "../../../api";
...
function periodsToRows(
  periods: BandOverview["activity_periods"]
): ActivityRow[] {
...
export default function ArtistAboutEditModal({
  bandId,
  data,
  onClose,
  onSaved,
    ...
    <ModalPortal onClose={onClose}>
      ...
      >
        ...
        <div className="artist-admin-form">
          ...
          <label>
            Other names (semicolon-separated)
            <input
              value={aliases}
          ...
          <label>
            ...
            <SearchableDropdown
              ...
              placeholder={selectedCountry?.label ?? data.country?.name ?? "Search country…"}
            />
          </label>
